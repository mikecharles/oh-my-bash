...
```shell
bash -c "$(curl -fsSL https://raw.githubusercontent.com/mikecharles/oh-my-bash/master/tools/install.sh)"
```

#### via wget

```shell
bash -c "$(wget https://raw.githubusercontent.com/mikecharles/oh-my-bash/master/tools/install.sh -O -)"
```
